...
run_adaptive_permutation_test_cpp <- function(precomp_list, x, side_code, h, alpha, test_stat_str) {
...
generate_wor_sample_test <- function(n, n_trt, n_samples) {
    .Call(`_adaptiveperm_generate_wor_sample_test`, n, n_trt, n_samples)
}
